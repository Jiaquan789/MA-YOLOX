...
class YOLOXHead(nn.Module):
    ...
    def get_losses(
        ...
        for batch_idx in range(outputs.shape[0]):
            ...
            if num_gt == 0:
                ...
                obj_target = o2o_mask.unsqueeze(-1)
    ...
    def get_assignments(
        ...
        # 进行o2o的标签分配
        o2o_cost = cost.clone()
        o2o_pair_wise_ious = pair_wise_ious
        o2o_gt_classes = gt_classes
        o2o_num_gt = num_gt
        o2o_mask = fg_mask.detach().clone()
        ...
        (
            ...
            _,
            _,
        ) = self.o2o_simota_matching(o2o_cost, o2o_pair_wise_ious, o2o_gt_classes, o2o_num_gt, o2o_mask)
        ...
        del o2o_pair_wise_ious, o2o_cost,

        # # 判断是否正确
        #
        # fg_count_true = fg_mask.sum().item()
        # o2o_count_true = o2o_mask.sum().item()
    ...
    def o2o_simota_matching(self, cost, pair_wise_ious, gt_classes, num_gt, fg_mask):
        matching_matrix = torch.zeros_like(cost, dtype=torch.uint8)

        n_candidate_k = min(10, pair_wise_ious.size(1))
        for gt_idx in range(num_gt):
            _, pos_idx = torch.topk(
                cost[gt_idx], k=1, largest=False
            )
            matching_matrix[gt_idx][pos_idx] = 1
            # cost[:, pos_idx] += float(1e5)
        del pos_idx
